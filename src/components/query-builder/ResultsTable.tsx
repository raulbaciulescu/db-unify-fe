...
const ResultsTable: React.FC<ResultsTableProps> = ({ data, darkMode }) => {
  ...
  if (!Array.isArray(data)) {
    const message = typeof data === 'object' && data !== null ? data.message : 'Operation completed successfully';
    const affectedRows = typeof data === 'object' && data !== null ? data.affectedRows : undefined;
